...
static void	ui_el_setup_default_logs(t_ui_el *el)
{
	...
	ui_event_add_listener(el->events->onPointerLeftButtonReleased,
			ui_log_el_left_button_released);
	ui_event_add_listener(el->events->onPointerRightButtonHold,
			ui_log_el_right_button_hold);
	ui_event_add_listener(el->events->onPointerRightButtonPressed,
			ui_log_el_right_button_pressed);
	ui_event_add_listener(el->events->onPointerRightButtonReleased,
...
void		ui_el_setup_default(t_ui_el *el)
{
	...
	ui_event_add_listener(el->events->onPointerEnter,
